...
class DashboardController extends Controller
{
    ...
    /**
    *    @OA\Get(
    *       path="/api/dashboard/total_call/{start_date}/{end_date}",
    *       tags={"Dashboard"},
    ...
    */
    ...
    /**
    *    @OA\Get(
    *       path="/api/dashboard/average_call_time/{start_date}/{end_date}",
    *       tags={"Dashboard"},
    ...
    */
    ...
    /**
    *    @OA\Get(
    *       path="/api/dashboard/current_call_session_detail_information/{start_date}/{end_date}",
    *       tags={"Dashboard"},
    ...
    */
    ...
    {
        $operator = Operator::whereBetween('created_at',[date($start_date), date($end_date)])->where(['name_agent'=>auth()->user()->name])->get();
        return OperatorResource::collection($operator);
    }

    /**
    *    @OA\Get(
    *       path="/api/dashboard/performance_hourly_today/{start_date}/{end_date}",
    *       tags={"Dashboard"},
    ...
    */
    ...
    {
        $data = Operator::where('created_at', '>=', Carbon::yesterday()->subDay())->get()->groupBy(function($date) {
    ...
    /**
    *    @OA\Get(
    *       path="/api/dashboard/total_agent",
    *       tags={"Dashboard"},
