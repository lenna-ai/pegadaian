...
Route::group(['middleware' => 'auth:api'],function (): void {
    ...
    Route::get('outlet/category', [HelpDeskController::class, 'category'])->middleware(['can:admin,help_desk']);
    Route::get('outlet/tag', [HelpDeskController::class, 'tag'])->middleware(['can:admin,help_desk']);
});
